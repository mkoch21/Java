...
public class MessagesRepositoryJdbcImpl implements MessageRepository {
    ...
    public void update(Message message) {
        ...
        if (message.getDateTime() == null) {
            ...
            str = "UPDATE chat.message SET message = \'" + message.getText() + "\', time  = " + null + " WHERE id = " + message.getMessageId();
        } else {
            str = "UPDATE chat.message SET message = \'" + message.getText() + "\', time  = \'" + message.getDateTime().format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")) + "\' WHERE id = " + message.getMessageId();
        }
